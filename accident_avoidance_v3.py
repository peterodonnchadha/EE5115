...
def steer_based_on_object_position(startX, endX, frame_width, distance_camera):
    steer_threshold = 200  # Threshold distance to start steering (in inches)
...
#         failsafe_distance_threshold = 40  # Threshold distance to stop the car (in cm)
# 
...
#             stop()
           # break
            ...
            #if (object_captured == 1 and distance_camera < 2):
                #print ("stop")
                #stop()
            #else:
                #print ("forward")
